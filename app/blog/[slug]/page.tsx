...
export async function generateMetadata({
  ...
  if (!blog) {
    return {
      title: "Odisha Healthcare Blog",
      description: "Odisha Healthcare Blog",
    }
  }

  return {
    title: `${blog.title} | Odisha Healthcare`,
...
const blogSchema = {
  ...
  image: [`https://Odisha Healthcare.in${blog.image}`],

  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": `https://Odisha Healthcare.in/blog/${safeSlug}`,
  },
  ...
  publisher: {
    ...
    logo: {
      "@type": "ImageObject",
      url: "https://Odisha Healthcare.in/logo.png",
    },
  },
