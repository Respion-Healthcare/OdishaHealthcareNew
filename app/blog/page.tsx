...
export const metadata: Metadata = {
  title: "Odisha Healthcare Blog | CPAP, Sleep Apnea & Respiratory Care Guides",
  description:
  ...
  alternates: {
    canonical: "https://www.Odisha Healthcare.in/blog",
  },
  robots: {
    index: true,
    follow: true,
...

{
  ...
  excerpt:
    "Rent CPAP, BiPAP, and oxygen concentrators from Odisha Healthcare with 3-hour delivery in Bhubaneswar, Kolkata, Ranchi, Patna, and Bangalore. Enjoy one-day delivery across the rest of India with genuine devices, expert support, and affordable rental plans.",
},
// {
//   id: 11,
//   slug: "oxygen-concentrator-price-in-india",
