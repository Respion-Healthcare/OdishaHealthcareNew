        ...
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white p-12 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="space-y-3 relative z-10">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-extrabold text-xl tracking-tight">Odisha Healthcare</span>
            </div>
            
            <h2 className="text-3xl font-extrabold leading-tight tracking-tight">Join Odisha Healthcare</h2>
          ...
          <div className="space-y-4 pt-12 relative z-10">
            ...
            <p className="text-[11px] text-blue-200/60 font-light">
              © {new Date().getFullYear()} Odisha Healthcare India. All rights reserved.
            </p>
          </div>
        </div>
