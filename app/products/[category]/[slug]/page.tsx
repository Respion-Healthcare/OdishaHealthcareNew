...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  return {
    title: `${product.name} | Odisha Healthcare`,
    description: `Explore ${product.name} with warranty, sleep apnea support, and fast delivery from Odisha Healthcare.`,
    alternates: {
      canonical: `https://www.Odisha Healthcare.in/products/${product.category}/${product.slug}`,
    },
    openGraph: {
      title: product.name,
    ...
    <div className="w-full px-4 sm:px-6 lg:max-w-7xl lg:mx-auto pt-8 pb-16">
      ...
      <div className="prose prose-lg max-w-none mt-20">
        ...
        <ul>
          ...
          <li>Backed by Odisha Healthcare expert team support</li>
        </ul>
      </div>
