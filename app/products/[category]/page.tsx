...
export async function generateMetadata({
  ...
  > = {
    ...
    */
    ...
    "cpap-machine": {
      ...
      description:
        "Buy premium CPAP machines online in India with advanced sleep apnea therapy technology, humidification support, intelligent airflow systems, and fast delivery from Odisha Healthcare.",
    ...
    */
    ...
    "oxygen-concentrator": {
      ...
      description:
        "Buy portable and home oxygen concentrators online in India with advanced oxygen therapy support, respiratory care solutions, and fast delivery from Odisha Healthcare.",
    ...
    */
    ...
    "cpap-rental": {
      ...
      description:
        "Affordable CPAP rental services for sleep apnea therapy with flexible plans, respiratory support, and fast delivery from Odisha Healthcare.",
  ...
  */
  ...
  const seo = seoMap[category] || {
    ...
    description:
      `Buy premium ${formattedCategory} online in India from Odisha Healthcare with warranty support and expert respiratory care assistance.`,
  ...
  return {
    ...
    alternates: {
      canonical: `https://Odisha Healthcare.in/products/${category}`,
    },
    ...
    openGraph: {
      ...
      url: `https://Odisha Healthcare.in/products/${category}`,
