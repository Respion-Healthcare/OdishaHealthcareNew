...
if (slug === "mask") {
  return {
    title: "CPAP Masks & BiPAP Masks Online in India | Odisha Healthcare",
    description:
...
if (slug === "accessory") {
  return {
    title: "CPAP & BiPAP Accessories Online in India | Odisha Healthcare",
    description:
  ...
  return {
    title: `${formattedName} Price in India | Buy Online - Odisha Healthcare`,
    description: `Buy ${formattedName} online in India at best price from Odisha Healthcare. Explore premium quality products with fast delivery and trusted support.`,
    keywords: [
      formattedName,
    ...
    openGraph: {
      title: `${formattedName} | Odisha Healthcare`,
    ...
    <p className="text-gray-600 text-sm">
      Support
        ...
        <p className="text-gray-600 mb-10 max-w-3xl">
          Explore premium quality {categoryTitle} products at Odisha Healthcare.
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: categoryTitle,
              url: `https://www.Odisha Healthcare.in/category/${slug}`,
              description: `Buy ${categoryTitle} online in India at best price from Odisha Healthcare.`,
              publisher: {
                "@type": "Organization",
                name: "Odisha Healthcare",
                url: "https://www.Odisha Healthcare.in",
              },
            }),
          }}
        />
