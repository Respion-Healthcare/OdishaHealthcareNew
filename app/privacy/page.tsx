...
export default function PrivacyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Odisha Healthcare India</title>
        <meta
          name="description"
          content="Read Odisha Healthcare's Privacy Policy to understand how we collect, use, protect, and process your personal information in compliance with Indian data protection laws."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Privacy Policy | Odisha Healthcare" />
        <meta
          property="og:description"
          content="Learn how Odisha Healthcare collects, uses, and safeguards your personal information."
        />
        <meta property="og:url" content="https://Odisha Healthcare.in/privacy-policy" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              name: "Privacy Policy",
              url: "https://Odisha Healthcare.in/privacy-policy",
              description:
                "Odisha Healthcare Privacy Policy explaining data collection, use, security practices, and user rights under Indian law.",
              publisher: {
                "@type": "Organization",
      ...
      <main className="pt-[120px] min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 mb-10 text-lg">
            ...
            Website: https://Odisha Healthcare.in
          </p>
          ...
          <div className="space-y-10 text-gray-700 leading-relaxed text-[16px]">
            ...
            <section>
              ...
              <p>
                This Privacy Policy describes how <strong>Odisha Healthcare</strong> collects,
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                third-party payment gateways. Odisha Healthcare does not store card
            ...
            <section className="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-lg shadow-sm">
              ...
              <p>
                Odisha Healthcare will never ask for your OTP, card PIN, net banking
                password, or sensitive credentials. If anyone requests such
                information claiming to represent Odisha Healthcare, please report it
                immediately.
              </p>
            </section>
