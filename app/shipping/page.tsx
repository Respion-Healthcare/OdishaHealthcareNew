...
export default function ShippingPage() {
  return (
    <>
      <Head>
        <title>Shipping Policy | Odisha Healthcare India</title>
        <meta
          name="description"
          content="Read Odisha Healthcare's Shipping Policy to understand vendor fulfillment, delivery timelines, shipping charges, tracking details, and delivery issue handling."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Shipping Policy | Odisha Healthcare" />
        <meta
          property="og:description"
          content="Learn how shipping and delivery are managed on the Odisha Healthcare marketplace platform."
        />
        <meta property="og:url" content="https://Odisha Healthcare.in/shipping-policy" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: "https://Odisha Healthcare.in/shipping-policy",
              description:
                "Odisha Healthcare Shipping Policy outlining vendor fulfillment, delivery timelines, shipping costs, and customer responsibilities.",
              publisher: {
                "@type": "Organization",
      ...
      <main className="pt-[120px] min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-gray-600 mb-10 text-lg">
            Thank you for choosing Odisha Healthcare. Please review this Shipping Policy carefully to understand how product delivery is managed through our platform.
          </p>
          ...
          <div className="space-y-10 text-gray-700 leading-relaxed text-[16px]">
            ...
            <section>
              ...
              <p>
                Odisha Healthcare operates primarily as a marketplace platform and does not directly handle the shipping of products. Each vendor listed on the Platform is solely responsible for the fulfillment and delivery of their respective products.
              </p>
            ...
            <section>
              ...
              <p className="mt-4 font-medium">
                Odisha Healthcare acts solely as a facilitator between buyers and vendors and is not liable for shipping-related issues.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                By placing an order through Odisha Healthcare, you acknowledge and agree to the terms outlined in this Shipping Policy.
              </p>
            </section>
