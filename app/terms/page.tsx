        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-14 space-y-12 text-gray-700 leading-relaxed">
          ...
          <div className="border-b border-gray-200 pb-8">
            ...
            <p className="text-gray-600 text-lg">
              ...
              <span>🌐 https://Odisha Healthcare.in</span>
            </p>
          </div>
          ...
          <section>
            <p className="text-lg text-gray-800">
              By accessing or using <strong>Odisha Healthcare</strong>, you agree to be
          ...
          <section className="space-y-4">
            ...
            <p>
              Odisha Healthcare is a marketplace platform connecting buyers and vendors.
              We provide a digital platform for browsing and purchasing products.
              Unless explicitly stated, Odisha Healthcare does not manufacture, stock,
          ...
          <section className="space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>• Acknowledge that Odisha Healthcare is not party to vendor contracts.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              All Odisha Healthcare branding, content, software, and design elements
          ...
          <section className="space-y-4">
            ...
            <p>
              Odisha Healthcare does not directly provide refunds. All disputes must be
          ...
          <section className="space-y-4">
            ...
            <p>
              Odisha Healthcare is not liable for vendor performance, disputes,
