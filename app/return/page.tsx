...
export const metadata: Metadata = {
  title: "Return & Refund Policy | Odisha Healthcare",
  description:
    "Read Odisha Healthcare's return, replacement, and refund policy for CPAP machines, BiPAP machines, oxygen concentrators, masks, and accessories.",
}
