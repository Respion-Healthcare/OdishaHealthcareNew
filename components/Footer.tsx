          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-5 pt-2">
              ...
              <a
                ...
                aria-label="Odisha Healthcare Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Odisha Healthcare YouTube"
              >
                <Youtube className="w-5 h-5 text-gray-500 hover:text-[#0391B6] hover:scale-110 transition duration-300 cursor-pointer" />
              </a>

              <a
                href="https://www.instagram.com/Odisha Healthcare_official/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Odisha Healthcare Instagram"
              >
