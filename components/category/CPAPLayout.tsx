...
<section className="mx-auto max-w-7xl px-4 pb-24 md:px-6">
  ...
  <div className="overflow-hidden rounded-[48px] bg-white shadow-xl">
    ...
    <div className="p-10 md:p-16">
      ...
      <h3 className="mt-16 text-3xl font-black text-slate-900">
        Why Buy CPAP Machines from Odisha Healthcare?
      </h3>

      <p className="mt-6 text-lg leading-relaxed text-slate-600">
        Odisha Healthcare offers genuine CPAP machines from trusted sleep therapy
  ...
  <div className="mx-auto max-w-5xl px-4 md:px-6">
    ...
    <div className="mt-12 space-y-4">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", url: "https://Odisha Healthcare.in" },
          { name: "Products", url: "https://Odisha Healthcare.in/products" },
          {
            name: "CPAP Machines",
            url: "https://Odisha Healthcare.in/products/cpap-machine",
          },
        ]}
      />
    </div>
