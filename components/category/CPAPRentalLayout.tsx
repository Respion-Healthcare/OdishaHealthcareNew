      ...
      <section className="border-t border-[#BFEAF3] bg-white py-24">
        ...
        <div className="mx-auto max-w-5xl px-4 md:px-6">
          ...
          <div className="mt-8 space-y-6 text-lg leading-relaxed text-slate-600">
            ...
            <p>
              At Odisha Healthcare, explore flexible CPAP & BiPAP rental plans, expert setup support, respiratory therapy assistance, and reliable sleep apnea care solutions
