...
export default function NasalMaskLayout({
 ...
 const faqs = [
  ...
  <div className="relative z-10">
          ...
          <h2 className="mt-16 text-3xl font-black text-slate-900">
            Why Buy Nasal CPAP Masks from Odisha Healthcare?
          </h2>

          <p className="mt-6 text-lg leading-relaxed text-slate-600">
            Odisha Healthcare offers a curated range of genuine nasal CPAP masks from
      ...
      <BreadcrumbSchema
        items={[
          ...
          {
            name: "Nasal Masks",
            url: "https://Odisha Healthcare.in/products/nasal-mask",
          },
        ]}
      />
