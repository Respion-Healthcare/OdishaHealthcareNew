...
const reviews = [
  ...
  // ✅ NEW REVIEW 1
  {
    name: "Sanjay Verma",
    review:
      "Odisha Healthcare provided an original ResMed CPAP machine at a very competitive price. The delivery was fast and customer support was extremely helpful.",
    rating: 5,
  },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Odisha Healthcare Healthcare",

            description:
              "Odisha Healthcare Healthcare provides CPAP machines, BiPAP machines, oxygen concentrators, respiratory care products, sleep apnea devices, and medical equipment across India.",
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10 mb-16">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed max-w-2xl">
                ...
                sleep apnea devices, and medical equipment from Odisha Healthcare
                Healthcare.
              </p>
